...
from inputdata.data import COLORS, click, top_apps, keys, top_access, unlocks, today_hour, weekly_hour, usage_time
...
def update_graph(date,btn1, btn2, btn3, btn4, btn5, btn6):
    ...
    today_unlock = unlocks["unlock"][k[0]]
    if (k[0]==0):
        differ_unlock=0
    else:
        differ_unlock = today_unlock - unlocks["unlock"][k[0]-1]
