...
#                 html.Div([
#                 html.Button(top[1], id='btn-nclicks-1', n_clicks=0, style=APP_BUTTON_STYLE),
#                 html.Button(top[2], id='btn-nclicks-2', n_clicks=0, style=APP_BUTTON_STYLE),
#                 html.Button(top[3], id='btn-nclicks-3', n_clicks=0, style=APP_BUTTON_STYLE),
#                 html.Button(top[4], id='btn-nclicks-4', n_clicks=0, style=APP_BUTTON_STYLE),
#                 html.Button(top[5], id='btn-nclicks-5', n_clicks=0, style=APP_BUTTON_STYLE),
#                 html.Button(top[6], id='btn-nclicks-6', n_clicks=0, style=APP_BUTTON_STYLE),
...
#     fig1 = go.Figure()
#     fig1.add_trace(go.Scatter(x=total['time'], y=total['top1'], mode='lines', name=top[1],line_color=GRAPH_COLOR[0]))
#     fig1.add_trace(go.Scatter(x=total['time'], y=total['top2'], mode='lines', name=top[2],line_color=GRAPH_COLOR[1]))
#     fig1.add_trace(go.Scatter(x=total['time'], y=total['top3'], mode='lines', name=top[3],line_color=GRAPH_COLOR[2]))
#     fig1.add_trace(go.Scatter(x=total['time'], y=total['top4'], mode='lines', name=top[4],line_color=GRAPH_COLOR[3]))
#     fig1.add_trace(go.Scatter(x=total['time'], y=total['top5'], mode='lines', name=top[5],line_color=GRAPH_COLOR[4]))
#     fig1.update_layout(
#         xaxis = dict(
#             title = "Time of Day",
#             tickmode = 'array',
